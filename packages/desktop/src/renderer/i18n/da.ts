export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af CHAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af CHAI er blevet downloadet. Vil du installere den og genstarte?",
