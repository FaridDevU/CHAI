export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju CHAI-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} CHAI-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
