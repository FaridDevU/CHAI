export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av CHAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av CHAI er lastet ned. Vil du installere den og starte på nytt?",
