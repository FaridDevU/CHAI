export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of CHAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of CHAI has been downloaded, would you like to install it and relaunch?",
