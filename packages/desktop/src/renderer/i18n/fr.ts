export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'CHAI",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'CHAI a été téléchargée. Voulez-vous l'installer et redémarrer ?",
