export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von CHAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von CHAI wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
