export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de CHAI",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de CHAI. ¿Quieres instalarla y reiniciar?",
