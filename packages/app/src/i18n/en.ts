export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CHAI",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CHAI.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "CHAI Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CHAI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CHAI.",
  ...
  "dialog.server.description": "Switch which CHAI server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "CHAI",
  ...
  "wsl.onboarding.checkingOpencode": "Checking CHAI...",
  "wsl.onboarding.checkingOpencodeIn": "Checking CHAI in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating CHAI...",
  "wsl.onboarding.updatingOpencodeIn": "Updating CHAI in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update CHAI in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update CHAI",
  "wsl.onboarding.opencodeReadyIn": "CHAI is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CHAI is ready.",
  "wsl.onboarding.installOpencodeIn": "Install CHAI in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install CHAI",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CHAI.",
  ...
  "toast.update.description": "A new version of CHAI ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CHAI team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CHAI does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CHAI includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the CHAI server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CHAI",
  ...
  "settings.general.row.appearance.description": "Customise how CHAI looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CHAI follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CHAI is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CHAI launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CHAI.",
